/*
 * Created by JFormDesigner on Sun May 01 09:19:26 CST 2022
 */
 ...
 * @author 1
 */
public class employeesUpdate extends JFrame {


    public employeesUpdate(Employees employees) {
        initComponents(employees);
    }

    private void initComponents(Employees employees) {
        label1 = new JLabel();
        label2 = new JLabel();
        label3 = new JLabel();
        label4 = new JLabel();
        ...
        textField1.setText(String.valueOf(employees.getE_id()));
        textField2.setText(employees.getE_name());
        textField3.setText(employees.getE_department());
        textField4.setText(employees.getE_posts());
        textField5.setText(String.valueOf(employees.getE_wages()));
        ...
        button1.addActionListener(
                e->{
                    ...
                    Employees emp = new Employees(id,name,department,posts,wages);
                    EmployeesDao employeesDao = new EmployeesDaoImpl();
                    employeesDao.update(emp,oId);//输入更改后的和原本的id
