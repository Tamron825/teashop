package cn.edu.guet.shopdemo.pay;

import cn.edu.guet.shopdemo.been.User;
import cn.edu.guet.shopdemo.sdk.WXPayUtil;
import cn.edu.guet.shopdemo.tablemodel.GetDataBase;
import cn.edu.guet.shopdemo.util.DateUtil;
...
public class WXPay {
    ...
    public static String scanCodeToPay(String auth_code) throws Exception {
        ...
        cn.edu.guet.shopdemo.sdk.WXPay wxpay = new cn.edu.guet.shopdemo.sdk.WXPay(config);
    ...
    下单：生成二维码
     */
    public static void unifiedOrder(User user) {
        Map<String, String> resultMap = new HashMap();
        String openid = "ouR0E1oP5UGTEBce8jZ_sChfH26g";
        MyConfig config = null;
        cn.edu.guet.shopdemo.sdk.WXPay wxpay = null;
        try {
            config = new MyConfig();
            wxpay = new cn.edu.guet.shopdemo.sdk.WXPay(config);
        } catch (Exception e) {
            e.printStackTrace();
        }
        //生成的随机字符串
        ...
        data.put("notify_url", "http://4o770y3825.zicp.vip/result");
        ...
        data.put("attach",t+"user_id,"+user_id+";");
    ...
    public static void createQRCode(Map<String, String> map) throws Exception {
        ...
        File outputFile = new File("D:\\ideaProject\\ShopSystem\\src\\main\\picture\\" + File.separator + "new.jpg");
